...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Check if roles table exists - if it does, add Spatie columns; otherwise create it
        if (!Schema::hasTable($tableNames['roles'])) {
            ...
            // Add Spatie required columns to existing roles table
            Schema::table($tableNames['roles'], static function (Blueprint $table) use ($teams, $columnNames, $tableNames) {
