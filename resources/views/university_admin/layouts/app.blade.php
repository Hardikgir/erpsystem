...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="{{ route('university.admin.dashboard') }}" class="brand-link">
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    ...
                    <small class="text-muted">{{ auth()->user()->role->role_name ?? 'University Admin' }}</small>
                </div>
            </div>

            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    @include('university_admin.layouts.sidebar')
                </ul>
            </nav>
        </div>
    </aside>
