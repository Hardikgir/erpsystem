    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ isset($college) ? route('university.admin.college.update', $college->id) : route('university.admin.college.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    @if(isset($college))
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('university.admin.college.master') }}" class="btn btn-secondary btn-sm">Cancel</a>
                            </div>
                        </div>
                    @endif
                </form>
                    ...
                    <tbody>
                        @forelse($colleges as $index => $college)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('university.admin.college.edit', $college->id) }}" class="btn btn-link" style="color: #1F8BFF; text-decoration: underline;">Update</a>
                                </td>
                            </tr>
                        @empty
                            <tr><td colspan="6" class="text-center">No colleges found.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
